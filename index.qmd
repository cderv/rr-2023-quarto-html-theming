...
## {background-image="images/quarto-html-screenshot2.png" background-size="1450px" visibility="uncounted"}
...
## {background-image="images/quarto-html-screenshot-bootswatch2.png" background-size="1450px" visibility="uncounted"}
...
Il est ainsi possible d'accéder 

* à toutes les variables Bootstrap
* aux variables spécifiques Quarto 
...
{{< fa tv >}} <https://cderv.github.io/rr-2023-html-theming> 

{{< fa brands github >}} <https://github.com/cderv/rr-2023-html-theming>
